...
class HiddenLayer(object):
    ...
    def hiddenWeightInit(self, numHiddenLayer):
        ...
        outputs = np.loadtxt(open("TrainedTeatClassification/DenseLayer" + str(numHiddenLayer) + ".csv", "rb"),delimiter=",")
        biases = np.loadtxt(open("TrainedTeatClassification/Dense" + str(numHiddenLayer) + "Bias.csv", "rb"),delimiter=",")

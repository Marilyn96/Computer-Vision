...
class HiddenLayer(object):
    ...
    def hiddenWeightInit(self, numHiddenLayer):
        ...
        outputs = np.loadtxt(open("TrainedTeatDetectionFinal/DenseLayer" + str(numHiddenLayer) + ".csv", "rb"),delimiter=",")
        biases = np.loadtxt(open("TrainedTeatDetectionFinal/Dense" + str(numHiddenLayer) + "Bias.csv", "rb"),delimiter=",")
        ...
        for i in range(self.numNeurons-1):
            ...
            weights[i][self.numInputs-1] = biases[i]
